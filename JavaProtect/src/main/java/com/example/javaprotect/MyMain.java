...
public class MyMain {
    ...
    public static void main(String[] args) throws Exception {
		...
		//解压apk
        File apkFile = new File("JavaProtect/source/aar/mylibrary-debug.aar");
//        File apkFile = new File("source/apk/app-debug.apk");
        File newApkFile = new File(apkFile.getParent() + File.separator + "temp");
		System.out.println(apkFile.exists()+" apkFile.exit=== "+apkFile);
		 ...
		 * 第二步 处理aar 获得壳dex
		 */
    	File aarFile = new File("JavaProtect/source/aar/mylibrary-debug.aar");
